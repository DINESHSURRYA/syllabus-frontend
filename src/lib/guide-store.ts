...
export const WORKFLOW_STEPS: WorkflowStep[] = [
  { id: 'code_verify', stepNumber: 1, title: 'Code Verification', shortName: '1. Verify Code', route: '/upload' },
  { id: 'upload_file', stepNumber: 2, title: 'Upload File', shortName: '2. Upload', route: '/upload' },
  { id: 'verification_review', stepNumber: 3, title: 'Verification & Save', shortName: '3. Verify & Save', route: '/verification' },
  { id: 'academic_strategy', stepNumber: 4, title: 'Academic Strategy', shortName: '4. Strategy', route: '/curriculum' },
];
  ...
  persist(
    (set, get) => ({
      ...
      setMinimized: (minimized) =>
        set({ isGuideMinimized: minimized }),

      setWorkflowStep: (step) =>
        set({ activeWorkflowStep: step }),
      ...
      setDuplicateDetectedCode: (code) =>
        set({ duplicateDetectedCode: code }),
