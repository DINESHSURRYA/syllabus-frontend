...
export default function CallControls({ isMicOn, setIsMicOn }: CallControlsProps) {
    ...
    <div className="flex items-center justify-between w-full max-w-xl px-6 py-4 bg-surface/5 backdrop-blur-md rounded-2xl border border-surface/10 mx-auto mt-6">
      ...
      <div className="flex gap-4 flex-1 justify-center">
        <button 
          ...
          className={cn(
            "p-4 rounded-full transition-all focus:outline-none focus:ring-2 focus:ring-accent cursor-pointer",
