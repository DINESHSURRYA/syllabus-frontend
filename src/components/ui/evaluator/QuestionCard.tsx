    ...
    <div className="bg-surface/5 border border-surface/10 rounded-xl overflow-hidden transition-all duration-300 hover:border-surface/20">
      ...
      >
        ...
        <div className="flex items-center gap-2 sm:gap-3 shrink-0">
          <span className={cn("px-2 py-1 rounded text-[10px] sm:text-xs font-mono font-medium border whitespace-nowrap", statusColors[question.status] || statusColors.Partial)}>
            {question.status}
          </span>
          <button className="text-muted hover:text-surface transition-colors p-1 cursor-pointer">
