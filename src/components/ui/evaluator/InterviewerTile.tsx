  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex items-center justify-center opacity-40">
        <div
          className={cn(
            "w-40 h-40 rounded-full border border-accent/20 absolute",
        ...
        <div
          className={cn(
            "w-28 h-28 rounded-full border border-accent/40 absolute",
            isPlaying && "animate-ping"
          )}
        ...
        <div
          className={cn(
            "w-16 h-16 rounded-full border border-accent/60 absolute",
            isPlaying && "animate-ping"
          )}
        ...
        <div
          className={cn(
            ...
            isPlaying
              ? "shadow-[0_0_30px_rgba(37,99,235,0.9)]"
      ...
      <div className="relative z-10 max-w-3xl flex h-full">
        {isTransitioning ? (
          ...
          <div className="mt-auto w-full max-w-full overflow-y-auto pr-2">
